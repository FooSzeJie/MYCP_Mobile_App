...
class StepProgressModal extends StatefulWidget {
  final String userId; // Pass the user ID when navigating to HomePage

  const StepProgressModal({Key? key, required this.userId}) : super(key: key);

  @override
  State<StepProgressModal> createState() => _StepProgressModalState();
}

class _StepProgressModalState extends State<StepProgressModal> {
